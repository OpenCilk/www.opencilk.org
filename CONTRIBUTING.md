...
Alternatively, with a local fork of the repository, you can work on the PR and see the results of each edit in 2-3 seconds, because regenerating your instance of the site on `localhost` is that much faster than regnerating on Netlify.
- **Comments.** Every time you save your changes with Netlify CMS, it adds the same generic comment to GitHub: "Update <collection-name> cms/<your-article>".
